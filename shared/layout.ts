...
export enum FurnitureKind { StreetLamp = 0, Bench = 1, Bollard = 2, MorrisColumn = 3, Fountain = 4, SubwayEntrance = 5, BusStop = 6, BikeRack = 7, WasteBasket = 8, Flagpole = 9, Car = 10, Statue = 11, Person = 20 }
